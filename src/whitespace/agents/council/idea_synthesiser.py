...
to copy.
- Where the critic marked candidates to combine ("Combine with"), \
cross-synthesise them into ONE proposal that keeps the strongest \
material from each — mitigate information loss; do not flatten \
details away.
- Preserve the input ranking order. Do not add new ideas and do not \
